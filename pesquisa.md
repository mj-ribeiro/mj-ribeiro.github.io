...
<ul class="paper-list">
    ...
    <li>
        ...
        <a href="https://mj-ribeiro.github.io/ide_wd.pdf">[<em>Link</em>]</a><br>
    ...
    <li>
        ...
        <a href="https://mj-ribeiro.github.io/ceper_index.pdf">[<em>Link</em>]</a><br>
...
<ul class="paper-list">
    ...
    <li>
     ...
     <li>
        <span class="paper-title">Bits vs. Atoms: Drivers of Digital and Traditional Goods Trade</span>
